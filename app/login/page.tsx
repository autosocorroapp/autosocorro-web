...
export default function LoginPage() {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      const userType = metadata.user_type || "driver";
    ...
    <>
      <section className="rounded-[28px] bg-white p-6 shadow-sm">
        ...
        <div className="mb-5">
          ...
          <p className="mt-2 text-sm text-neutral-500">Entre com e-mail e senha.</p>
        </div>
      ...
      <section className="mt-5 rounded-[28px] bg-white p-5 shadow-sm">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="font-semibold">Acesso com senha</h2>
            <p className="mt-1 text-sm text-neutral-500">
              Não usamos OTP/magic link como fluxo principal de autenticação.
            </p>
          </div>
        </div>
      </section>

...
const services = [
  ...
  },
  {
    ...
    value: "Litros + combustível + taxa",
    icon: Fuel
  },
  {
    name: "Diagnóstico mecânico",
    value: "R$ 80 + deslocamento",
    icon: Wrench
  },
  {
    name: "Guincho",
    value: "R$ 100 + distância",
    icon: Truck
  }
];
    ...
    <main className="mx-auto min-h-screen max-w-md px-4 py-6">
      ...
      <section className="rounded-3xl bg-white p-5 shadow-sm">
        ...
        <h1 className="text-2xl font-bold">
          Socorro automotivo rápido
        </h1>

        <p className="mt-2 text-sm text-neutral-600">
          Conectamos você a prestadores próximos para resolver problemas
          no carro ou moto em poucos minutos.
        </p>
